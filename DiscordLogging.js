...
//   const LogChannel = client.channels.cache.get("1016616468886073384"); // Replace with your channel id
...
//     .setColor("#2F3136")
//     .setDescription(
//       `Message Edited from \`${oldContent}\` to \`${newContent}\``
//     );
...
//     .setColor("#2F3136")
//     .setDescription(
//       `${user.tag} updated thier username from ${oldUsername} to ${newUsername}`
//     );
...
//       .setColor("#2F3136")
//       .setDescription(
//         `${user.tag} updated thier discriminator from ${oldDiscriminator} to ${oldDiscriminator}`
//       );
...
//     .setColor("#2F3136")
//     .setDescription(
//       `${user.tag} updated thier flags from ${oldFlags} to ${newFlags}`
//     );
